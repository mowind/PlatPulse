...
//!
//! Phase 0 provides the thin-binary/library split only: config/CLI, the
//! per-Node collectors, the Node Supervisor, the AgentStore spool, and the
//! report sender arrive in later tickets. Keep startup logic in this library
