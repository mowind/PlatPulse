...
# one Owner for the Playwright suite. The suite runs against the real Server
# serving the production WebUI build, so login and the Home/Admin shells are
# exercised end to end (design §12.2, §14.1).
set -euo pipefail
