...
export const adminGeoStatus = <ThrowOnError extends boolean = false>(options?: Options<AdminGeoStatusData, ThrowOnError>): RequestResult<AdminGeoStatusResponses, unknown, ThrowOnError> => (options?.client ?? client).get<AdminGeoStatusResponses, unknown, ThrowOnError>({ url: '/api/admin/v1/geo', ...options });
