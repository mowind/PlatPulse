...
export const publicValidatorAnalytics = <ThrowOnError extends boolean = false>(options: Options<PublicValidatorAnalyticsData, ThrowOnError>): RequestResult<PublicValidatorAnalyticsResponses, PublicValidatorAnalyticsErrors, ThrowOnError> => (options.client ?? client).get<PublicValidatorAnalyticsResponses, PublicValidatorAnalyticsErrors, ThrowOnError>({ url: '/api/public/v1/validators/{validator_id}/analytics', ...options });

export const publicValidatorHistory = <ThrowOnError extends boolean = false>(options: Options<PublicValidatorHistoryData, ThrowOnError>): RequestResult<PublicValidatorHistoryResponses, PublicValidatorHistoryErrors, ThrowOnError> => (options.client ?? client).get<PublicValidatorHistoryResponses, PublicValidatorHistoryErrors, ThrowOnError>({ url: '/api/public/v1/validators/{validator_id}/history', ...options });
