...
export const createValidator = <ThrowOnError extends boolean = false>(options: Options<CreateValidatorData, ThrowOnError>): RequestResult<CreateValidatorResponses, CreateValidatorErrors, ThrowOnError> => (options.client ?? client).post<CreateValidatorResponses, CreateValidatorErrors, ThrowOnError>({
...
export const createNodeValidatorLink = <ThrowOnError extends boolean = false>(options: Options<CreateNodeValidatorLinkData, ThrowOnError>): RequestResult<CreateNodeValidatorLinkResponses, CreateNodeValidatorLinkErrors, ThrowOnError> => (options.client ?? client).post<CreateNodeValidatorLinkResponses, CreateNodeValidatorLinkErrors, ThrowOnError>({
...
export const updateValidatorLink = <ThrowOnError extends boolean = false>(options: Options<UpdateValidatorLinkData, ThrowOnError>): RequestResult<UpdateValidatorLinkResponses, UpdateValidatorLinkErrors, ThrowOnError> => (options.client ?? client).put<UpdateValidatorLinkResponses, UpdateValidatorLinkErrors, ThrowOnError>({
...
export const endValidatorLink = <ThrowOnError extends boolean = false>(options: Options<EndValidatorLinkData, ThrowOnError>): RequestResult<EndValidatorLinkResponses, EndValidatorLinkErrors, ThrowOnError> => (options.client ?? client).post<EndValidatorLinkResponses, EndValidatorLinkErrors, ThrowOnError>({
